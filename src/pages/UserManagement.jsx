...
const UserManagement = () => {
  ...
  return (
    <div style={{ paddingBottom: '3rem', maxWidth: '1100px', margin: '0 auto' }}>
      ...
      {/* ── EDIT MODAL ── */}
      {editUser && (
        <div style={{ position: 'fixed', inset: 0, background: 'rgba(10,15,28,0.85)', backdropFilter: 'blur(4px)', display: 'flex', zIndex: 200, padding: '24px', overflowY: 'auto' }}>
          <div className="glass-panel" style={{ margin: 'auto', width: '100%', maxWidth: '500px', padding: '32px', position: 'relative' }}>
      ...
      {showCreate && (
        <div style={{ position: 'fixed', inset: 0, background: 'rgba(10,15,28,0.85)', backdropFilter: 'blur(4px)', display: 'flex', zIndex: 200, padding: '24px', overflowY: 'auto' }}>
          <div className="glass-panel" style={{ margin: 'auto', width: '100%', maxWidth: '460px', padding: '32px', position: 'relative' }}>
