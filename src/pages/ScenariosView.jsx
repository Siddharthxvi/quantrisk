...
const ScenariosView = () => {
  ...
  return (
    <div className="page-animate">
      ...
      {isModalOpen && (
        <div style={{ position: 'fixed', inset: 0, backgroundColor: 'rgba(10, 15, 28, 0.8)', backdropFilter: 'blur(4px)', display: 'flex', zIndex: 100, padding: '24px', overflowY: 'auto' }}>
          <div className="glass-panel modal-animate" style={{ margin: 'auto', width: '100%', maxWidth: '400px', padding: '24px', position: 'relative' }}>
